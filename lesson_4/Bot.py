...
# Зациклюємо спілкування
while True:
    # Знаходимо в строке контрольні слова, фрази, що ввів користувач та обираємо необхідну умову(фразу)
    ...
    # Заглиблюємо умову, щоб відповісти коректно
...
"Вартові галактик", він просто бомба!')
    ...
    # Надаємо користувачу змогу знову ввести текст(повідомлення)
