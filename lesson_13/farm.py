...
if __name__ == '__main__':
    ...
    # Для всіх представників класів Cow, Cat, Hen, Dog виводить перевірку голодна чи сита
    # наприкінці дня (тобто активності). Виводить на екран які тварини потребують догляду.
    is_ok_count = 0
    ...
    # Якщо всі тварини нагодовані виводить повідомлення
    if is_ok_count == 0:
