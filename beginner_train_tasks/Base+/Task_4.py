...
year_intercalary = False

# Якщо високосний рік
if year % 4 == 0 and (year % 100 != 0 or year % 400 == 0):
    year_intercalary = True
...
# якщо в місяці  30 днів
    ...
    if 1 <= day <= 30:
        ...
        print('Невірна дата!!!')
# якщо в місяці  29 днів у високосний рік
elif month == 2 and year_intercalary:
    if 1 <= day <= 29:
        print('Така дата існує')
    else:
        print('Невірна дата!!!')

# якщо в місяці  28 днів у звичайни рік
elif month == 2 and not year_intercalary:
    if 1 <= day <= 28:
        print('Така дата існує')
    else:
        print('Невірна дата!!!')
